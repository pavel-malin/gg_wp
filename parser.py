...
# Proxie tor's
proxie = {'http': 'socks5://127.0.0.1:9050', 'https': 'socks5://127.0.0.1:9050'}
...
# Parse site
    ...
    if not connection ==True:
        ...
        page = requests.get("http://" + str(url.split()[0]), heades=header)
        soup = BeautifulSoup(page.text, "http.parser")
